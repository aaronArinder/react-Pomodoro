...
class Pomodoro extends Component {
  ...
  render() {
    return (
      <div>
        <div>
          {this.state.displayTimerMinutes} m : {this.state.displayTimerSeconds}{' '}
          s
        </div>
        ...
        <form onSubmit={this.handleSubmit.bind(this)}>
          ...
          <input
            ...
            max="10"
            defaultValue="3"
            onChange={this.handleChangePomoNumber.bind(this)}
          />
        </form>
        Completed Pomos: {this.state.completedPomos} /{' '}
        {this.state.numberOfPomos}
